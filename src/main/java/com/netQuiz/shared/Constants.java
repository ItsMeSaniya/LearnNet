...
public class Constants {
    ...
    public static final int SERVER_PORT = 5000; // Single port for all TCP operations
    public static final int UDP_NOTIFICATION_PORT = 5001; // Separate UDP port for broadcasts
